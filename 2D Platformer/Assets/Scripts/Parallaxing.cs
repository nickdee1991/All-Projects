...
public class Parallaxing : MonoBehaviour {
        ...
        // the previous frame had the current frames camera position
    {
        ...
        {
            parallaxScales[i] = backgrounds[i].position.z * -1; // going through each background and assigning that background set position to the corresponding parallax scale
        }
	}
